function [orientationMap, depthMap, costMap] = RightToLeft(orientationMap, image1_struct, otherImage_struct, depthMap, mapDistribution, costMap, halfWindowSize, near, far)
